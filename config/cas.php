...
return [
    ...
    */
    'cas_real_hosts'      => env('CAS_REAL_HOSTS', 'cas.ksau-hs.edu.sa'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url'      => env('CAS_LOGOUT_URL', 'https://cas.ksau-hs.edu.sa/cas/logout'),
    ...
    */
    ...
    'cas_user_mapper' => \Subfission\Cas\LaravelUserMapper::class,
];
